...
//typedef char T_Emp[K_MaxEmp]; //utilisez d'abord ce type puis,
...
typedef enum {janv, fevr, mars, avri, mai,  juin,
                     juil, aout, sept, octo, nove, dece}T_Mois ;
...
typedef struct
{
  ...
  // Attention il peut y avoir pluieurs livres de même titre (le code
